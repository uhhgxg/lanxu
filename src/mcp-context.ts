...
/**
 * Claude-native MCP is project/host context, not a 澜序-managed user MCP
 * grant.  Materialize it explicitly so strict Agent MCP filtering cannot hide
 * it (and cannot accidentally re-enable unselected 澜序 user servers).
...
/** 澜序-managed MCP is an additive final layer. */
