    ...
    >
      ...
      >
        ...
        <div
          ...
          className="flex flex-wrap items-center gap-3 px-6 py-4 max-lg:px-4 max-lg:py-2.5 max-lg:bg-background/60 max-lg:backdrop-blur-xl max-lg:saturate-[1.8] max-lg:border-border/40"
        >
          {onBack && (
            <button
          ...
          <div className="min-w-44 flex-1">
            <p className="mb-0.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-primary/80">
              当前工作区
            </p>
          ...
          {currentContextWaiting && (
            <span
              ...
              className="hidden h-8 shrink-0 items-center gap-1.5 rounded-md bg-emerald-50 px-2.5 text-[11px] font-medium text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300 sm:inline-flex"
            >
          ...
          {canModifyWorkspaceConfig && (
            ...
            >
              ...
              <span className="hidden 2xl:inline">工作区设置</span>
            </button>
          )}
          {canModifyWorkspaceConfig && (
            <button
