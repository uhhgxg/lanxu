      ...
      <div className="max-w-4xl mx-auto w-full px-4 py-3">
        ...
        <div className="lg:flex lg:gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div data-message-surface="assistant" className="bg-surface rounded-xl border border-border/60 px-5 py-4 font-serif shadow-card">
              <div
                role="status"
                aria-live="polite"
                className="flex items-center gap-2"
    ...
    <div className="max-w-4xl mx-auto w-full px-4 py-3">
      ...
      <div className="lg:flex lg:gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            data-message-surface={hasWorkflowCards ? undefined : 'assistant'}
            className={
              hasWorkflowCards
