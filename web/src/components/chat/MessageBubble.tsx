...
export const MessageBubble = memo(
  function MessageBubble({
    ...
    if (isUser) {
      ...
      return (
        <div data-message-kind="user" data-message-shell="true" className="group flex justify-end mb-4">
            ...
            <div className="relative">
              ...
              {!hasOnlyImages && (
                <div
                  ...
                  data-message-surface="user"
                  className="bg-muted text-foreground px-4 py-2.5 rounded-2xl rounded-tr-sm"
                >
    ...
    return (
      <div data-message-kind="assistant" className="group mb-4">
        ...
        <div className="lg:flex lg:gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Glass surface for the reply; actions remain outside the panel. */}
            <div data-message-surface="assistant" className="overflow-hidden font-serif">
              {completedWorkflowRuns?.map((run) => (
                <WorkflowRunCard key={run.taskId} run={run} />
              ))}
