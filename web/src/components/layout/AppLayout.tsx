...
export function AppLayout() {
  ...
  useEffect(() => {
    const appName = appearance?.appName || '澜序';
  ...
  return (
    <div
      data-app-shell="true"
      className="atelier-workspace h-screen supports-[height:100dvh]:h-dvh flex flex-col lg:flex-row overflow-hidden safe-area-top"
    >
