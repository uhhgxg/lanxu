...
export function LoginPage() {
  ...
  return (
    <div className="landing-page min-h-screen supports-[min-height:100dvh]:min-h-dvh bg-background overflow-y-auto relative">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-4 lg:px-12">
        <div className="flex items-center gap-3">
          ...
          <span className="brand-wordmark text-lg text-foreground">
            澜序
          </span>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            <Button variant="ghost" size="sm">
              ...
              <span className="hidden sm:inline">项目源码</span>
            </Button>
          </a>
        </div>
      </header>
