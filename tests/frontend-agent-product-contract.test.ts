...
describe('Agent-first frontend product contracts', () => {
  ...
  it('shows the legacy built-in Agent name as 澜序', () => {
    expect(getAgentProfileDisplayName('Default Agent')).toBe('澜序');
    expect(getAgentProfileDisplayName(undefined)).toBe('澜序');
