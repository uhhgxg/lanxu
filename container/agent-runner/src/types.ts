/**
 * Shared types for Miniclaw Agent Runner.
 *
...
/**
 * Sanitized, per-input-turn channel identity supplied by the Miniclaw host.
 *
...
export interface ContainerInput {
  ...
  /** Canonical effective Skill set resolved by the Miniclaw host. */
